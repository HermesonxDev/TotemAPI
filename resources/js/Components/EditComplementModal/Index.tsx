...
import { Complement, ComplementForm, Image as ImageInterface, Product } from "@/utils/interfaces"

import api from "@/Services/api";
import Loading from "../Loading";
import { ProductImage } from "../EditProductModal/styles";

interface IEditComplementModalProps {
    show: boolean,
...
const EditComplementModal: React.FC<IEditComplementModalProps> = ({
    show,
    editedProduct,
    ...
    useEffect(() => {
        if (editedProduct) {
            ...
            const mappedImages =
                editedProduct.staticImage?.map((img) => ({
                    photo: img.photo,
                    _id: new ObjectId().toString(),
                    active: true,
                    isNew: false
