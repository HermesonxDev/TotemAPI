...
export const General = styled.div`
    ...
    */
    ...
    grid-template-rows: 6% 8% 8% 8% 8% 46% 10% 6%;
...
export const TotemConfig = styled.div`
    ...
    */
    grid-template-columns: 100%;
    grid-template-rows: 6.5% 8% 8% 8% 8% 8.5% 8% 20.5% 20.5% 4%;
...
export const TotemConfigRow8 = styled.div`
    grid-area: row8;
    margin-top: 10px;
`;

export const TotemConfigRow9 = styled.div`
    grid-area: row9;
    margin-top: 10px;
`;

export const TotemConfigRow10 = styled.div`
    grid-area: row10;
    display: flex;
    flex-direction: row;
    justify-content: flex-end;
...
export const GeneralConfig = styled.div`
    ...
    */
    grid-template-columns: 100%;
    grid-template-rows: 8% 8% 8% 8% 8% 8% 8% 8% 8% 24% 4%;
    grid-template-areas: "row1" "row2" "row3" "row4" "row5" "row6" "row7"  "row8" "row9" "row10" "row11";
`;

export const GeneralConfigRow1 = styled.div`
    grid-area: row1;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
export const GeneralConfigRow2 = styled.div`
    grid-area: row2;
`;

export const GeneralConfigRow3 = styled.div`
    grid-area: row3;
`;

export const GeneralConfigRow4 = styled.div`
    grid-area: row4;
`;

export const GeneralConfigRow5 = styled.div`
    grid-area: row5;
`;

export const GeneralConfigRow6 = styled.div`
    grid-area: row6;
`;

export const GeneralConfigRow7 = styled.div`
    grid-area: row7;
`;

export const GeneralConfigRow8 = styled.div`
    grid-area: row8;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
export const GeneralConfigRow9 = styled.div`
    grid-area: row9;
    display: flex;
    align-items: center;
`;

export const GeneralConfigRow10 = styled.div`
    grid-area: row10;
    display: flex;
    flex-direction: column;
    justify-content: space-between;
...
export const GeneralConfigRow11 = styled.div`
    grid-area: row11;
    display: flex;
    flex-direction: row;
    justify-content: flex-end;
...
export const Others = styled.div`
    ...
    */
    grid-template-columns: 100%;
    grid-template-rows: 8% 8% 8% 8% 4% 20% 20% 20% 4%;
    grid-template-areas: "row1" "row2" "row3" "row4" "row5" "row6" "row7" "row8" "row9";
`;

export const OthersRow1 = styled.div`
    grid-area: row1;
`;

export const OthersRow2 = styled.div`
    grid-area: row2;
`;

export const OthersRow3 = styled.div`
    grid-area: row3;
`;

export const OthersRow4 = styled.div`
    grid-area: row4;
    display: flex;
    align-items: center;
`;

export const OthersRow5 = styled.div`
    grid-area: row5;
    display: flex;
    flex-direction: row;
    align-items: center;
...
export const OthersRow6 = styled.div`
    grid-area: row6;
    margin-top: 10px;
`;

export const OthersRow7 = styled.div`
    grid-area: row7;
    margin-top: 10px;
`;

export const OthersRow8 = styled.div`
    grid-area: row8;
    margin-top: 10px;
`;

export const OthersRow9 = styled.div`
    grid-area: row9;
    display: flex;
    flex-direction: row;
    justify-content: flex-end;
