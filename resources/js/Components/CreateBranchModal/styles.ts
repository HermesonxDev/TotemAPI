...
export const General = styled.div`
    ...
    */
    ...
    grid-template-rows: 6% 8% 8% 8% 8% 8% 8% 8% 8% 8% 8% 8% 6%;
    grid-template-areas: "row1" "row2" "row3" "row4" "row5" "row6" "row7" "row8" "row9" "row10" "row11" "row12" "row13";
`;
...
export const GeneralRow13 = styled.div`
    grid-area: row13;
    display: flex;
    flex-direction: row;
