...
import { Branch, Category, Company, Complement, ProductForm, ProductFormOptions, Image as ImageInterface, Product } from "@/utils/interfaces"
...
const CreateProductModal: React.FC<ICreateProductModalProps> = ({ show, categoriesComplements, onClose }) => {
    ...
    return (
        <Modal show={show} onClose={closeForm}>
            <Container>
                <Header>
                    <Title margin="1rem 0 0 0.75rem">Criar Produto</Title>
                    <Button
                        type="button"
                        margin="0.75rem"
                        onClick={closeForm}
